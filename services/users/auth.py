...
SECRET_KEY = os.getenv("SECRET_KEY")  # Must be kept secret! Used to sign JWTs
ALGORITHM = os.getenv("ALGORITHM", "HS256")  # JWT signing algorithm
ACCESS_TOKEN_EXPIRE_MINUTES = int(os.getenv("ACCESS_TOKEN_EXPIRE_MINUTES", 1440))  # 24 hours default

# Password hashing context using bcrypt
# bcrypt is specifically designed for password hashing (slow and secure)
pwd_context = CryptContext(
    schemes=["bcrypt"],     # Use bcrypt algorithm
    deprecated="auto"       # Auto-migrate from old schemes if needed
)
