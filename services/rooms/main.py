...
- Room search and filtering by capacity, location, equipment
- Room availability status tracking
- Equipment management for rooms
- Real-time room status updates via RabbitMQ
...
app = FastAPI(
    title="Meeting Rooms Service API",
    description="""
## Smart Meeting Room Management Service

This service provides comprehensive meeting room management capabilities including:

### Features
* **Room Management**: Create, update, delete, and retrieve meeting rooms
* **Room Search & Filtering**: Search rooms by capacity, location, and available equipment
* **Room Status**: Check real-time availability status of rooms
* **Equipment Tracking**: Manage room equipment and resources
...
- **Manager**: Can create, update, and delete rooms
- **User**: Can view rooms and check availability
